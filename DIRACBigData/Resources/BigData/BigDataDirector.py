...
from DIRACBigData.Resources.BigData.SoftBigDataDirector           import SoftBigDataDirector
from DIRACBigData.WorkloadManagementSystem.Client.AmazonImage     import AmazonImage
from DIRACBigData.WorkloadManagementSystem.Client.CloudStackImage import CloudStackImage
from DIRACBigData.WorkloadManagementSystem.Client.OcciImage       import OcciImage

__RCSID__ = '$Id: $'

class BigDataDirector( VMDirector ):
