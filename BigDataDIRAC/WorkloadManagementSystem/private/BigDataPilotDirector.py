...
class BigDataPilotDirector( PilotDirector ):
  """
  ...
  def configure( self, csSection, submitPool ):
    ...
    self.log.error( '::::::::::::::::...x3', self.__failingCECache.getKeys() )
    self.log.error( '::::::::::::::::...x3', self.computingElementDict )
    if self.__failingCECache.getKeys() != []:
  ...
  def _submitPilots( self, workDir, taskQueueDict, pilotOptions, pilotsToSubmit,
    ...
    self.log.exception( ':::::::::::::1x', self.computingElementDict )
