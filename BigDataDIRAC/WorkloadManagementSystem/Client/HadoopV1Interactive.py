...
from BigDataDIRAC.WorkloadManagementSystem.Client.HadoopV1InteractiveClient      import HadoopV1InteractiveClient
...
class HadoopV1Interactive:
  ...
  def __init__( self, NameNode, Port, jobID, PublicIP, User, JobName, Dataset ):
    ...
    self.log = gLogger.getSubLogger( "Hadoop Version 1, HadoopInteractive HHL, NameNode: %s" % ( NameNode ) )
    self.log.info( "Hadoop Version 1, HadoopInteractive Version 1, Port: %s" % ( Port ) )
    self.log.info( "Hadoop Version 1, HadoopInteractive Version 1, jobID: %s" % ( jobID ) )
    self.log.info( "Hadoop Version 1, HadoopInteractive Version 1, PublicIP: %s" % ( PublicIP ) )
    self.log.info( "Hadoop Version 1, HadoopInteractive Version 1, User: %s" % ( User ) )
    self.log.info( "Hadoop Version 1, HadoopInteractive Version 1, JobName: %s" % ( JobName ) )
    self.log.info( "Hadoop Version 1, HadoopInteractive Version 1, Dataset: %s" % ( Dataset ) )
